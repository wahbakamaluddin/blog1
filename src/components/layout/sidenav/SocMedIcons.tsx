...
export default function SocMedIcons () {
    ...
    return (
        <div className="flex flex-row gap-3">
            <Link href={links[0]} className="hover:text-emerald-500"> <FiLinkedin size={22}/> </Link>
            <Link href={links[1]} className="hover:text-emerald-500"> <FiGithub size={22}/> </Link>
            <Link href={links[2]} className="hover:text-emerald-500"> <FiYoutube size={22}/> </Link>
