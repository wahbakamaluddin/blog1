...
![Screenshot 2025-12-09 at 21.30.01.png](/image/writing/competition/curtinctf25-web-agent-jonathan-walkings-trafalgar/1.png)
...
- Under repeater tab, change the “alg” into HS256, and add “admin”: true under the payload then sign the message using the previously created key
    ...
    ![image.png](/image/writing/competition/curtinctf25-web-agent-jonathan-walkings-trafalgar/4.png)
